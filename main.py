...
DATABASE_URL ="postgres://ytjxdfylbtmyju:14ebd6426f020c14a79f0e0c1dd6871fdaa48bd95181cba6464945a47894828b@ec2-54-91-188-254.compute-1.amazonaws.com:5432/ddd3ajgvtjfgd8"


host_server = os.environ.get('host_server','localhost')
db_server_port= urllib.parse.quote_plus(str(os.environ.get('db_server_port','5432')))
database_name= os.environ.get('database_name','fastapi')
#database_name= os.environ.get('database_name','Notas_Estudiantes')
